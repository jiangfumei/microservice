...
@Slf4j
public class OauthAuthenticationFilter implements ReactiveAuthenticationManager {
    ...
    public Mono<Authentication> authenticate(Authentication authentication) {
        return Mono.justOrEmpty(authentication)
                ...
                .flatMap((accessToken ->{
                    ...
                    OAuth2AccessToken oAuth2AccessToken = (OAuth2AccessToken) this.tokenStore.readAccessToken(accessToken);
